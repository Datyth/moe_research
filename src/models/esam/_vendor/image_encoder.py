...
# meant the raw image tensor skipped patch embedding and only the first of
# `depth` transformer blocks ever ran). Both restored/dedented below so the
# full ViT actually executes.
...
class AdapterBlock(nn.Module):
    """Transformer block with window attention, residual propagation and Adapters."""
